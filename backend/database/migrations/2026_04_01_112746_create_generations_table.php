...
return new class extends Migration {
    public function up()
    {
        // Crée la table si elle n'existe pas encore (cas Supabase / base neuve)
        ...
        // Ajoute les colonnes seulement si elles n'existent pas déjà (cas local, table déjà existante)
